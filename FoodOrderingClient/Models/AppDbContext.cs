...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Fid).HasName("PK__Food__D9908D641B956C55");
        ...
        {
            entity.HasKey(e => e.Oid).HasName("PK__Orders__C2FFCF1357F4B494");
        ...
        {
            entity.HasKey(e => e.Uid).HasName("PK__Users__DD701264F69895A4");
